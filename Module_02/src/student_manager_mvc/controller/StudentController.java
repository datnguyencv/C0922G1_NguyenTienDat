package student_manager_mvc.controller;

import student_manager_mvc.service.IStudentService;
import student_manager_mvc.service.imlp.StudentService;
import student_manager_mvc.service.utils.exception.SearchException;
...
public class StudentController {
    public static void studentManagement() throws IOException, ClassNotFoundException {
        ...
        while (true) {
            System.out.println("---------------------------------------");
            System.out.println("Chào mừng bạn đến với lớp C1022G1");
