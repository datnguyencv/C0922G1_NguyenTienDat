package student_manager_mvc.service.imlp;

import student_manager_mvc.model.Student;
import student_manager_mvc.service.IStudentService;
import student_manager_mvc.service.read_and_write.ReadFileUtil;
import student_manager_mvc.service.read_and_write.WriteFileUtil;
import student_manager_mvc.service.utils.exception.*;
import student_manager_mvc.service.utils.validate.Validate;
...
public class StudentService implements IStudentService {
    ...
    private static final String PATH_FILE = "src/student_manager_mvc/data/students.txt";
...
//        }
    ...
    private String getDateOfBirthAndCheck() {
        String dateOfBirth;
        while (true) {
            dateOfBirth = String.valueOf(Validate.inputId("DateOfBirth"));
            if (checkDateOfBirth(dateOfBirth)) {
                break;
            } else {
                System.out.println("DateOfBirth " + dateOfBirth + " đã tồn tại");
            }
        }
        return dateOfBirth;
    }
