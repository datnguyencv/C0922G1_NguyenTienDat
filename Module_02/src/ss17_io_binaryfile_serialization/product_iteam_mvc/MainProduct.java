package ss17_io_binaryfile_serialization.product_iteam_mvc;
...
public class MainProduct {
    public static final String DATA_LIST_ITEM = "src/ss17_io_binaryfile_serialization/product_iteam_manager/repository/product.txt";
